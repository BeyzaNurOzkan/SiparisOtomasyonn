...
namespace SiparisOtomasyon
{
    ...
    //    public string[,] Address = new string[5, 3];
    ...
    //            {
    //                this.ID = (int)sdr["ID"];
    //                this.FirstName = (string)sdr["FirstName"];
    //                this.LastName = (string)sdr["LastName"];
    ...
    //        SqlCommand cmd = new SqlCommand("insert into Users(Name,userPhone,userName,userPassword) values (@Name,@userPhone,@userName,@userPassword)", connection);
    ...
    //        this.UserPassword = UserPassword;
    //        this.UserID = UserID;
    //        SqlCommand cmd = new SqlCommand("update Users set Name=@Name,userPhone=@userPhone,userPassword=@userPassword where userID=@userID",connection);
    //        cmd.Parameters.AddWithValue("@Name", this.Name);
    //        cmd.Parameters.AddWithValue("@userPhone", this.UserPhone);
    //        cmd.Parameters.AddWithValue("@userPassword", this.UserPassword);
